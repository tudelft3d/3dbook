...
For DTMs for example, equally meaningful decompositions into parts can be made, \eg\ the MAT allows us to decompose a DTM into separate hills, watercourses and other objects on top of the DTM (see Figure~\ref{fig:matterrain}).
...
Both of these implementations could be stored using half-edge data structures (\refchap{chap:brep}) can store this directly.
