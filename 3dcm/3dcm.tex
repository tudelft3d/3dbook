...
\begin{kaobox-warning}[frametitle=\faExclamationTriangle\ There is no XML encoding yet for CityGML v3.0.0]
  At the moment of writing this book (January 2023), the CityGML-XML encoding has not been finalised yet.
  \\ \\
  There is however a draft available: \faExternalLink\ \url{https://github.com/opengeospatial/CityGML-3.0Encodings/}, which should be adapted soon.
\end{kaobox-warning}
